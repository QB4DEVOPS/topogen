...
- [x] ~~**Task: Bump `pyproject.toml` version to `0.2.5`.**~~ Done — `pyproject.toml` version updated to `"0.2.5"`. Generated lab descriptions now show `Generated by topogen v0.2.5`.
